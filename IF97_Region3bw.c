...
double if97_r3a_v_pt (double p_MPa, double t_K){
	...
	const typR3RedCoefs V3A_PT_RC = {
		0.0024, 100.0, 760.0, 30, 0.085, 0.817, 1, 1, 1
	};
	...
	return V3A_PT_RC.vStar * pow(omegasum , V3A_PT_RC.c );
}
...
double if97_r3b_v_pt (double p_MPa, double t_K){
	...
	return V3B_PT_RC.vStar * pow(omegasum , V3B_PT_RC.c );
}
...
double if97_r3c_v_pt (double p_MPa, double t_K){
	...
	const typR3RedCoefs V3C_PT_RC = {
		0.0022, 40.0, 690.0, 35, 0.259, 0.903, 1, 1, 1
	};
	...
	return V3C_PT_RC.vStar * pow(omegasum , V3C_PT_RC.c );
}
...
double if97_r3d_v_pt (double p_MPa, double t_K){
	...
	const typR3RedCoefs V3D_PT_RC = {
		0.0029, 40.0, 690.0, 38, 0.559, 0.939, 1, 1, 4
	};
...
//typIF97Coeffs_IJn *const ptrIJNCoeffs[] ;
...
//
/*double if97_r3xx_v_pt (double p_MPa, double t_K, double vStar , double pStar, double tStar, 
		int n, double a, double b, double c, double d int e,  ){
