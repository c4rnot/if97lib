...
*/
	...
	printf ("\n\n************************************************************ \n" );
	printf ("IF97 REGION 2 T(p, s) BACKWARDS EQUATIONS CHECK \n\n" );
	printf ("The output should be the following: \n\n");
	
	printf ("Region\tp(MPa)\ts(kJ/kg.K)\tT(K)\n");
	printf ("-------------------------------------------------\n");
	printf ("2a\t0.1\t7.5\t\t3.99517097E02\n");
	printf ("2a\t0.1\t8\t\t5.14127081E02\n");
	printf ("2a\t2.5\t8\t\t1.03984917E03\n");
	printf ("-------------------------------------------------\n");
	printf ("2b\t8\t6\t\t6.00484040E02\n");
	printf ("2b\t8\t7.5\t\t1.06495556E03\n");
	printf ("2b\t90\t6\t\t1.03801126E03\n");
	printf ("-------------------------------------------------\n");
	printf ("2c\t20\t5.75\t\t6.97992849E02\n");
	printf ("2c\t80\t5.25\t\t8.54011484E02\n");
	printf ("2c\t80\t5.75\t\t9.49017998E02\n\n");	
		
	printf ("*******OUTPUT************\n");
	printf ("Region\tp(MPa)\ts(kJ/kg.K)\tT(K)\n");
	printf ("-------------------------------------------------\n");
	
	printf ("2a\t0.1\t7.5\t\t%.8e\n", if97_r2a_t_ps(0.1,  7.5) );
	printf ("2a\t0.1\t8\t\t%.8e\n", if97_r2a_t_ps(0.1,  8.0) );
	printf ("2a\t2.5\t8\t\t%.8e\n", if97_r2a_t_ps(2.5,  8.0) );
		printf ("-------------------------------------------------\n");	
	printf ("2b\t8\t6\t\t%.8e\n", if97_r2b_t_ps(8.0,  6.0) );
	printf ("2b\t8\t7.5\t\t%.8e\n", if97_r2b_t_ps(8.0,  7.5) );
	printf ("2b\t90\t6\t\t%.8e\n", if97_r2b_t_ps(90.0,  6.0) );
		printf ("-------------------------------------------------\n");		
		printf ("-------------------------------------------------\n");	
	printf ("2c\t20\t5.75\t\t%.8e\n", if97_r2c_t_ps(20.0,  5.75) );
	printf ("2c\t80\t5.25\t\t%.8e\n", if97_r2c_t_ps(80.0,  5.25) );
	printf ("2c\t80\t5.75\t\t%.8e\n", if97_r2c_t_ps(80.0,  5.75) );
